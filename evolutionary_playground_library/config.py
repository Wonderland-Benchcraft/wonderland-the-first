...
FOOD_HP_COEF=1
POSTMORTEM_FOOD_HP_COEF=0.8
SIMULATION_STEPS_PER_GENERATION = 3000
NUMBER_OF_NEAT_GENERATIONS = 200
...
FITNESS_SURVIVAL_WEIGHT = 4
FITNESS_FOOD_WEIGHT = 4.0
FITNESS_HP_BONUS_WEIGHT = 2.0 # Applied to normalized HP if alive at end
FITNESS_SURVIVAL_MEDIAN_WEIGHT = 5
FITNESS_FOOD_MEDIAN_WEIGHT = 3
